...
public class JunglePyramidFinder extends AbstractTempleFinder {
    ...
    public List<BlockPos> findInChunk() {
        ...
        result.forEach((pieceFinder, positions) -> {
            ...
            positions.forEach(pos -> {
                ...
                this.addRenderers(pieceFinder, pos, 0xFFFF00FF);
            });
        });
    ...
    public void buildStructure(PieceFinder finder) {
        ...
        finder.addBlock(Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.WIRE_CONNECTION_SOUTH, WireConnection.SIDE), 5, -3, 6);
        finder.addBlock(Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.WIRE_CONNECTION_SOUTH, WireConnection.SIDE), 5, -3, 5);
        finder.addBlock(Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.WIRE_CONNECTION_SOUTH, WireConnection.SIDE), 5, -3, 4);
        finder.addBlock(Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.WIRE_CONNECTION_SOUTH, WireConnection.SIDE), 5, -3, 3);
        finder.addBlock(Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.WIRE_CONNECTION_SOUTH, WireConnection.SIDE), 5, -3, 2);
