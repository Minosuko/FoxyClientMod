...
public class Config {
    ...
    private static final File file = new File(net.fabricmc.loader.api.FabricLoader.getInstance().getConfigDir().toFile(), "foxyclient_seedcracker.json");
    ...
    private MCVersion version = MCVersion.v1_21;
