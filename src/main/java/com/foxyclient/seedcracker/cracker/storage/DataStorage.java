...
import com.foxyclient.seedcracker.config.SeedCrackerScreen;
...
import com.foxyclient.seedcracker.cracker.decorator.DeepDungeon;
...
import com.foxyclient.seedcracker.finder.BlockUpdateQueue;
...
public class DataStorage {
    ...
    public void tick() {
        if (openGui) {
            SeedCrackerScreen screen = new SeedCrackerScreen(MinecraftClient.getInstance().currentScreen);
            MinecraftClient.getInstance().setScreen(screen);
            openGui = false;
        }
        this.blockUpdateQueue.tick();
    ...
    // Legacy compatibility for addHashedSeed(long)
    public void addHashedSeed(long hashedSeed) {
        addHashedSeedData(new HashedSeedData(hashedSeed), DataAddedEvent.POKE_LIFTING);
    }
